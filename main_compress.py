...
from util.dataset import get_image_dataset
...
def get_args_parser():
    ...
    parser.add_argument(
        "-d", "--dataset_path", type=str, required=True, help="Training dataset path"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--seed", default=0, type=int, help="Set random seed for reproducibility"
    )
    parser.add_argument(
        "--clip_max_norm",
        default=1.0,
    ...
    parser.add_argument(
        "--checkpoint", type=str, default="", help="Path to a checkpoint"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=144,
        help="number of visual patches to input the model",
    )
    return parser
...
def main(args):
    ...
    train_dataset = get_image_dataset(mode="train", args=args)
    test_dataset = get_image_dataset(mode="val", args=args)
