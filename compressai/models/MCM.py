...
class MCM(CompressionModel):
    ...
    def forward_encoder(self, x, total_scores):
        # embed patches
        ...
        x, ids_keep = self.random_masking(x, total_scores)
    ...
    def forward_decoder(self, x, ids_keep):
        ...
        noise = torch.rand(ids_keep.shape[0], 196, device=x.device)  # noise in [0, 1]
